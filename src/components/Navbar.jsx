    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'glassmorphism py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8 text-sm font-sans font-semibold text-fnx-silver items-center">
          ...
          {/* Separator */}
          <div className="w-[1px] h-4 bg-fnx-silver/30"></div>

          {/* Strategic Affiliate */}
          <div className="flex items-center group cursor-pointer">
            <span className="text-fnx-gold-light text-[10px] tracking-widest mr-2 opacity-80 uppercase">LIÊN KẾT</span>
            <Link to="/affiliate/xlbm" className="hover:text-white transition-colors relative text-white">
              BAN XLBM
        ...
        <div className="hidden md:flex space-x-6 items-center">
           <Link to="/logs" className="text-fnx-silver text-[10px] font-sans font-bold tracking-widest hover:text-white transition-colors">
             DỰ ÁN
           </Link>
           <Link to="/engage" className="px-6 py-2 border border-fnx-silver/30 text-white text-sm font-sans font-bold tracking-wide hover:border-fnx-gold-light hover:text-fnx-gold-light transition-colors duration-300">
             LIÊN HỆ
           </Link>
        </div>
      </div>
