    ...
    <section className="relative w-full h-[120vh] min-h-[800px] bg-surface-blueprint overflow-hidden flex flex-col items-center py-24">
      ...
      <div className="absolute inset-0 max-w-[1400px] mx-auto w-full h-full pointer-events-none">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30 pointer-events-auto">
          <div className="relative w-32 h-32 md:w-40 md:h-40 flex items-center justify-center rounded-sm border border-fnx-gold-dark/50 bg-[#0B1120] shadow-[0_0_40px_rgba(200,154,61,0.15)]">
            {/* Core Pulse */}
            <div className={`absolute inset-0 rounded-sm bg-fnx-gold-dark/10 animate-ping transition-opacity duration-500 ${isHovered ? 'opacity-100' : 'opacity-0'}`}></div>
            <img src={logoFNX} alt="FNX Group Logo" className="h-10 md:h-12 w-auto object-contain relative z-10" />
          </div>
        </div>
