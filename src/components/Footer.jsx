      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <Link to="/">
              <img src={logoFNX} alt="FNX Group" className="h-8 w-auto mb-6 grayscale opacity-80 hover:opacity-100 hover:grayscale-0 transition-all duration-300" />
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4 text-fnx-silver text-sm">
              <li><Link to="/affiliate/xlbm" className="hover:text-fnx-gold-light transition-colors">Đối Tác Chiến Lược VASI</Link></li>
              <li><Link to="/hubs/sc" className="hover:text-fnx-gold-light transition-colors">Chuỗi Cung Ứng</Link></li>
              <li><Link to="/hubs/rd" className="hover:text-fnx-gold-light transition-colors">Nghiên Cứu & Phát Triển</Link></li>
              <li><Link to="/hubs/m" className="hover:text-fnx-gold-light transition-colors">Trung Tâm Sản Xuất</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-fnx-silver text-sm">
              ...
              <li><Link to="/engage" className="hover:text-white transition-colors">Liên Hệ</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-fnx-silver text-sm">
              ...
              <li><Link to="/security" className="hover:text-white transition-colors">Bảo Mật Hệ Thống</Link></li>
            </ul>
          </div>
        </div>
