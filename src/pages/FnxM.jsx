...
export default function FnxM() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  const capabilities = [
    { title: "Gia công Bề mặt", desc: "Trực tiếp vận hành dây chuyền gia công, xử lý bề mặt chuyên sâu." },
    { title: "Quản lý Chất lượng", desc: "Đảm bảo chất lượng chế tạo và sản lượng đáp ứng khắt khe các tiêu chuẩn công nghiệp." },
    { title: "Dây chuyền Lắp ráp", desc: "Vận hành hệ thống dây chuyền lắp ráp hiện đại, chuẩn hóa quy trình sản xuất." }
  ];
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8">
        ...
        <div className="relative rounded-[2rem] bg-fnx-matrix p-12 md:p-24 overflow-hidden border border-white/5 mb-24 group">
          ...
          <div className="relative z-10 max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-sans font-bold text-white tracking-widest mb-4">FNX-M</h1>
            <h2 className="text-fnx-gold-light text-xl md:text-2xl font-sans tracking-widest mb-8 uppercase">Trung tâm Sản xuất</h2>
            <p className="text-fnx-silver text-lg md:text-xl leading-relaxed border-l-2 border-fnx-gold-dark pl-6">
              Trái tim vận hành của hệ sinh thái. Biến công nghệ lõi thành những khối kim loại và bề mặt hoàn hảo nhất.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#0C141C] border border-fnx-gold-dark/20 rounded-2xl p-12 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-white font-bold text-2xl">Sản lượng: Tối đa</p>
            </div>
